...
This is a project to process the raw data of [Nogizaka Lib](https://shawnrivers.github.io/nogizaka-lib-redesign/) project to make them instantly available for the View.
